...
class ResNetTypeII(tf.keras.Model):
    def __init__(self, layer_params):
        ...
        self.zero_pad = tf.keras.layers.ZeroPadding2D(padding=((3, 3), (3, 3)), name='conv1_pad')
        self.conv1 = tf.keras.layers.Conv2D(filters=64,
                                            kernel_size=(7, 7),
                                            strides=2,
                                            padding="same")
        ...
        # self.act0 = tf.keras.layers.Activation('relu', name='conv1_relu')
        # self.zp0 = tf.keras.layers.ZeroPadding2D(padding=((1, 1), (1, 1)), name='pool1_pad')
